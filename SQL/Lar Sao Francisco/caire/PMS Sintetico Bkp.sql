SELECT AF8.AF8_FILIAL FILIAL
	...
	,(
		SELECT round(SUM(NVL(SC7.C7_QUANT * SC7.C7_PRECO, 0)),2)
		FROM AJ7010 AJ7
...
SELECT AF84.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF84.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 2))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 3))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
