...
(SELECT B1.B1_DESC FROM SB1010 B1 WHERE B1.B1_COD = D1.D1_COD AND B1.D_E_L_E_T_=' ' AND ROWNUM = 1) PRODUTO,
D1.D1_UM UNIDADE,
D1.D1_QUANT /** CASE WHEN D1.D1_RATEIO = '1' THEN (DE.DE_PERC/100) ELSE 1 END*/ QUANTIDADE,
D1.D1_VUNIT /** CASE WHEN D1.D1_RATEIO = '1' THEN (DE.DE_PERC/100) ELSE 1 END*/ VALOR_UNITARIO,
D1.D1_TOTAL /** CASE WHEN D1.D1_RATEIO = '1' THEN (DE.DE_PERC/100) ELSE 1 END*/ TOTAL ,
...
/*CASE WHEN D1.D1_CC = ' ' THEN DE.DE_CC ELSE D1.D1_CC END CENTRO_CUSTO,
...
AND D1.D1_FILIAL = DE.DE_FILIAL AND D1.D1_RATEIO = '1' AND D1.D1_ITEM = DE.DE_ITEMNF AND DE.D_E_L_E_T_=' '
*/
WHERE D1.D_E_L_E_T_=' ' AND SUBSTR(D1.D1_EMISSAO,1,4) = :ANO
