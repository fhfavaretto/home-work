SELECT AF8.AF8_FILIAL FILIAL
	...
	,(
		SELECT round(SUM(NVL(((SC7.C7_QUANT-SC7.C7_QUJE)-SC7.C7_QUJE) * SC7.C7_PRECO, 0)),2)
		FROM AJ7010 AJ7
	...
	,(
		...
		FROM AFN010 AFN
		INNER JOIN SD1010 SD1 ON SD1.D1_FILIAL = AFN.AFN_FILIAL
		...
		WHERE AFN.AFN_FILIAL = AF8.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= CASE WHEN AF8_START = ' ' THEN cast(null as date) ELSE LAST_DAY(to_date(AF8_START, 'YYYYMMDD')) END
		) TOTAL_NOTA
	,(
	...
	,MAX(AF9.AF9_X_PC01) + MAX(AF9.AF9_X_TR01) + MAX(AF9.AF9_X_AP01)  - (
		NVL((
				SELECT Round(SUM(NVL((SC7.C7_QUANT-SC7.C7_QUJE) * SC7.C7_PRECO, 0)),2)
				FROM AJ7010 AJ7
				INNER JOIN SC7010 SC7 ON SC7.C7_FILIAL = AJ7.AJ7_FILIAL
					AND SC7.C7_NUM = AJ7.AJ7_NUMPC
					AND SC7.C7_ITEM = AJ7.AJ7_ITEMPC
...
SELECT AF82.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF82.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(to_date(AF82.AF8_START, 'YYYYMMDD'))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF82.AF8_START, 'YYYYMMDD'), 1))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF83.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF83.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 1))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 2))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF84.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF84.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			/*AND TRIM(SD1.D1_X_DTPMS) <> ' '*/
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN /*cast(null as date)*/ TO_DATE(SD1.D1_DTDIGIT,'YYYYMMDD') ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 2))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN /*cast(null as date)*/ TO_DATE(SD1.D1_DTDIGIT,'YYYYMMDD') ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 3))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF85.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF85.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 3))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 4))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF86.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF86.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 4))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 5))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF87.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF87.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 5))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 6))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF88.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF88.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 6))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 7))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF89.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF89.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 7))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 8))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF810.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF810.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 8))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 9))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF811.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF811.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 9))
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 10))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
...
SELECT AF812.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF812.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' '
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END > LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 10))
			/*AND CASE WHEN SD1.D1_X_DTPMS = ' ' THEN cast(null as date) ELSE to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') END <= LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 11))*/
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
