/*SELECT AF8.AF8_FILIAL FILIAL
    ...
    WHERE AJ7.AJ7_FILIAL = AF8.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <=  LAST_DAY(to_date(AF8_START, 'YYYYMMDD'))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF8.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <=  LAST_DAY(to_date(AF8_START, 'YYYYMMDD'))
		) TOTAL_NOTA
	,(
		...
		WHERE AFR.AFR_FILIAL = AF8.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <=  LAST_DAY(to_date(AF8_START, 'YYYYMMDD'))
		) TOTAL_TITULO
...
AND AF8_FILIAL||AF8_PROJET||AF9_TAREFA NOT IN (SELECT ZC_FILIAL||ZC_PROJETO||ZC_TAREFA FROM SZC010 WHERE SZC010.D_E_L_E_T_ <> '*')
...
SELECT AF82.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF82.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(to_date(AF82.AF8_START, 'YYYYMMDD'))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF82.AF8_START, 'YYYYMMDD'), 1))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF82.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(to_date(AF82.AF8_START, 'YYYYMMDD'))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF82.AF8_START, 'YYYYMMDD'), 1))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF82.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(to_date(AF82.AF8_START, 'YYYYMMDD'))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF82.AF8_START, 'YYYYMMDD'), 1))
		) TOTAL_TITULO
...
SELECT AF83.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF83.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 1))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 2))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF83.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 1))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 2))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF83.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 1))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF83.AF8_START, 'YYYYMMDD'), 2))
		) TOTAL_TITULO
...
SELECT AF84.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF84.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 2))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 3))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF84.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 2))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 3))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF84.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 2))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF84.AF8_START, 'YYYYMMDD'), 3))
		) TOTAL_TITULO
...
SELECT AF85.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF85.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 3))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 4))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF85.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 3))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 4))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF85.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 3))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF85.AF8_START, 'YYYYMMDD'), 4))
		) TOTAL_TITULO
...
SELECT AF86.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF86.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 4))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 5))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF86.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 4))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 5))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF86.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 4))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF86.AF8_START, 'YYYYMMDD'), 5))
		) TOTAL_TITULO
...
SELECT AF87.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF87.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 5))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 6))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF87.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 5))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 6))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF87.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 5))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF87.AF8_START, 'YYYYMMDD'), 6))
		) TOTAL_TITULO
...
SELECT AF88.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF88.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 6))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 7))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF88.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 6))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 7))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF88.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 6))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF88.AF8_START, 'YYYYMMDD'), 7))
		) TOTAL_TITULO
...
SELECT AF89.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF89.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 7))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 8))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF89.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 7))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 8))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF89.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 7))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF89.AF8_START, 'YYYYMMDD'), 8))
		) TOTAL_TITULO
...
SELECT AF810.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF810.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 8))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 9))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF810.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 8))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 9))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF810.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 8))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF810.AF8_START, 'YYYYMMDD'), 9))
		) TOTAL_TITULO
...
SELECT AF811.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF811.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 9))
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 10))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF811.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 9))
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 10))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF811.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 9))
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF811.AF8_START, 'YYYYMMDD'), 10))
		) TOTAL_TITULO
...
SELECT AF812.AF8_FILIAL FILIAL
	...
	,(
		...
		WHERE AJ7.AJ7_FILIAL = AF812.AF8_FILIAL
			...
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) > LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 10))
			AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF812.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 10))
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF812.AF8_FILIAL
			...
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') > LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 10))
			/*AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= LAST_DAY(ADD_MONTHS(to_date(AF812.AF8_START, 'YYYYMMDD'), 11))*//*
		) TOTAL_TITULO
...
SELECT 
	...
	,AF9.AF9_DESCRI DESC_TAREFA
	,AF8.AF8_REVISA
	, TO_DATE(ZC_DTINI,'YYYYMMDD') INICIO_PERIODO
	,MAX(ZC_VALOR)+MAX(ZC_APLICA)+MAX(ZC_TRANSF) ORÇADO
	,(
    ...
    WHERE AJ7.AJ7_FILIAL = AF8.AF8_FILIAL
			...
			AND AJ7.AJ7_REVISA = AF8.AF8_REVISA
			AND AJ7.D_E_L_E_T_ = ' '
			AND to_date( C7_X_DTCON, 'yyyymmdd' ) <= to_date(ZC_DTFIM, 'YYYYMMDD')
      		AND to_date( C7_X_DTCON, 'yyyymmdd' ) >= to_date(ZC_DTINI, 'YYYYMMDD')
      AND (
				SELECT count(*)
				FROM SD1010 SD1
				WHERE D1_FILIAL = SC7.C7_FILIAL
	...
	,(
		...
		WHERE AFN.AFN_FILIAL = AF8.AF8_FILIAL
			...
			AND AFN.D_E_L_E_T_ = ' ' AND SD1.D1_DOC IN (SELECT AFN_DOC FROM AFN010 WHERE AFN010.D_E_L_E_T_=' ' AND AFN_FILIAL = SD1.D1_FILIAL) 
      		AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= (to_date(ZC_DTFIM, 'YYYYMMDD'))
      		AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') >= (to_date(ZC_DTINI, 'YYYYMMDD')) 
		) TOTAL_NOTA
	,(
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF8.AF8_FILIAL
			...
			AND AFR.AFR_REVISA = AF8.AF8_REVISA
			AND AFR.D_E_L_E_T_ = ' '
			AND to_date(AFR.AFR_DATA, 'YYYYMMDD') <= (to_date(ZC_DTFIM, 'YYYYMMDD')) 
    		AND to_date(AFR.AFR_DATA, 'YYYYMMDD') >= (to_date(ZC_DTINI, 'YYYYMMDD'))
		) TOTAL_TITULO
	, MAX(ZC_VALOR)+MAX(ZC_APLICA)+MAX(ZC_TRANSF) - (
		NVL((
				SELECT round(SUM(NVL(CASE WHEN C7_RESIDUO = 'S' THEN C7_QUJE ELSE SC7.C7_QUANT END * SC7.C7_PRECO, 0)),2)
		FROM AJ7010 AJ7
		LEFT JOIN SC7010 SC7 ON SC7.C7_FILIAL = AJ7.AJ7_FILIAL
    ...
    WHERE AJ7.AJ7_FILIAL = AF8.AF8_FILIAL
      ...
      AND (
		...
		WHERE AFN.AFN_FILIAL = AF8.AF8_FILIAL
			...
			AND TRIM(SD1.D1_X_DTPMS) <> ' '
			AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') <= (to_date(ZC_DTFIM, 'YYYYMMDD')) 
      		AND to_date(SD1.D1_X_DTPMS, 'YYYYMMDD') >= (to_date(ZC_DTINI, 'YYYYMMDD')) ), 0)
      +NVL((
		SELECT SUM(AFR.AFR_VALOR1)
		FROM AFR010 AFR
		WHERE AFR.AFR_FILIAL = AF8.AF8_FILIAL
