...
EXEC msdb.dbo.sysmail_add_account_sp
    ...
    @description = 'Conta de e-mail para ser utilizada pela Upduo',
    @email_address = 'auditoria_sistema@upduo.com.br',
    @replyto_address = 'fabio.favaretto@Upduo.com.br',
    @display_name = 'Auditoria Banco de dados',
    @mailserver_name = 'mail.upduo.com.br',
    @mailserver_type = 'SMTP',
    @port = '587',
    @username = 'auditoria_sistema@upduo.com.br',
    @password = 'Mustaine25%#!',
    @enable_ssl = 1,
