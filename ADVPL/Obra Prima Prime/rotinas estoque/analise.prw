...
Função Rotina analisar movimentacao e saldo em estoque. Controle de lote e localizacao ativo. 
@author  Reinaldo Dias
@since   19/08/2005
@version 12.1.27
@history 16/11/2022, fabio.favaretto, Adicionado Protheusdoc
/*/
//-------------------------------------------------------------------
...
Local cPictSBJ  := PesqPict('SBJ','BJ_QINI')
...
@ 035,043 MSGET oVar   VAR nQuant   Picture cPictSBJ    SIZE 050,10 PIXEL OF oDlgSBJ 
                                                     //fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cEndereco,cNumSeq,cTipoMov,cNumLote,cSerie,cCliFor,cLoja)
...
Local cPictSBK  := PesqPict('SBK','BK_QINI')
...
@ 035,043 MSGET oVar   VAR nQuant   Picture cPictSBK    SIZE 050,10 PIXEL OF oDlgSBK 
                                                     //fAjusta(cOpcao,cLoteCtl,cDoc,dData,nQuant,cEndereco,cNumSeq,cTipoMov,cNumLote,cSerie,cCliFor,cLoja)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Local _cPergunt := Padr("MTA300",10)
DBSelectArea("SX1")
DBSetOrder(1)
If DbSeek(_cPergunt+"01")
   RecLock("SX1",.F.)
   SX1->X1_CNT01 := cLocal
   MsUnlock()
Endif
If DbSeek(_cPergunt+"02")
   RecLock("SX1",.F.)
   SX1->X1_CNT01 := cLocal
   MsUnlock()
Endif
If DbSeek(_cPergunt+"03")
   RecLock("SX1",.F.)
   SX1->X1_CNT01 := cProduto
   MsUnlock()
Endif
If DbSeek(_cPergunt+"04")
   RecLock("SX1",.F.)
   SX1->X1_CNT01 := cProduto
   MsUnlock()
Endif
