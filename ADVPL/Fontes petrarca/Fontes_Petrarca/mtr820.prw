...
@Li  ,  0 PSAY REPLICATE("-",22)+" Responsável: "+(cAliasTop)->c2_usuario+" Emitente: " + SUBSTR(CUSUARIO,7,15)
LI:=LI+1

@LI  ,  0 PSAY "Informações do Try-Out : " +(cAliasTop)->C2_INFTRYO
Li++

If !(Empty((cAliasTop)->C2_OBS))
	@Li,00 PSay "Observação: "
